...
#include "WhatIsRTSPServer.hpp"

#include <live555/Base64.hh>
#include <live555/GroupsockHelper.hh>
#include <live555/ProxyServerMediaSession.hh>
#include <live555/RTSPCommon.hh>
#include <live555/RTSPRegisterSender.hh>
...
RTSPServer*RTSPServer::createNew(UsageEnvironment& env,
    ...
    return new RTSPServer(
        env, ourSocket, ourPort, authDatabase, reclamationSeconds);
}

Boolean RTSPServer::lookupByName(UsageEnvironment& env,
                                 char const* name,
                                 RTSPServer*& resultServer) {
    resultServer = nullptr;
    ...
    resultServer = static_cast<RTSPServer*>(medium);
    return True;
}

void rtspRegisterResponseHandler(RTSPClient* rtspClient,
                                 int resultCode,
                                 char* resultString);
...
public:
    RegisterRequestRecord(
        ...
        ourServer.fPendingRegisterRequests->Add(
            reinterpret_cast<char const*>(this), this);
    }
