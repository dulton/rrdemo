 ...
 */
#ifndef RRDEMO__CDOM__LIVE555__H264_NETWORK_ABSTRACT_LAYER_UNIT__HPP
#define RRDEMO__CDOM__LIVE555__H264_NETWORK_ABSTRACT_LAYER_UNIT__HPP
...
/// H.264 网络抽象层单元 辅助增强信息，nal_unit_type = 6。
struct H264NALUSupplementalEnhancementInformation {};

/// H.264 网络抽象层单元 序列参数集（），nal_unit_type = 7。
struct H264NALUSequenceParameterSet {
...
/// H.264 网络抽象层单元 图片参数集（），nal_unit_type = 8。
struct H264NALUPictureParameterSet {};

/// H.264 网络抽象层单元。
struct H264NetworkAbstractLayerUnit {
    /// 检查输入数据是否符合 H264 NALU Header。
...
#endif// RRDEMO__CDOM__LIVE555__H264_NETWORK_ABSTRACT_LAYER_UNIT__HPP
